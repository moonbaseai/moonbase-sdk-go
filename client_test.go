...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Collections.Get(context.Background(), "people")
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Collections.Get(context.Background(), "people")
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Collections.Get(cancelCtx, "people")
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Collections.Get(deadlineCtx, "people")
		if err == nil {
